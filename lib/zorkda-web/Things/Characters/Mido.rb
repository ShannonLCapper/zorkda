	...
	def dialogue(game_status)
		...
		if checkpoint < 2
			...
			player.equipment.each do |piece|
				if piece.equipped && (piece.is_a?(Deku_shield) || piece.is_a?(Kokiri_sword))
					proper_equipment += 1
				end
			end
			if self.moved
				return "I, the great Mido, will never accept you as one of us!
...
Huh?! Grumble... grumble..."
				...
				return "If you want to see the Great Deku Tree, you should at least equip a sword and shield!
...
Sheesh!"
				...
				return "If you want to pass through here, you should at least equip a sword and shield!
Sheesh!"
			end
		else
