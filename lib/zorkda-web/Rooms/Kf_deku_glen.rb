class Kf_deku_glen < Room
	...
	def entry_cutscene(game_status)
		dialogue = "You walk into a wide glen. Before you stands the massive Deku Tree.

Navi: \"Great Deku Tree... I'm back!\"

Great Deku Tree: \"Oh... Navi...
Thou hast returned...
...
listen well to her words of wisdom with the command \"Navi\".\""
	...
	def checkpoint_cutscenes(game_status, cutscene_num)
		if cutscene_num == 2
			dialogue = "You land with a glow of light into the Great Deku Tree's glen.
...
Great Deku Tree...\""
			...
			puts "\n\n\n\n\n\n\n\n"
			puts "You have reached the end of this trial. There will hopefully be more coming soon.
Thanks for playing!"
			exit(0)
		else
			puts "error"
