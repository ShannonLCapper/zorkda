def find_matches_search_all(curr_room, typed_obj)
...
def find_matches(possibilities, typed_obj)
	matches = []
...
def find_matches_search_all_id_parent(curr_room, typed_obj)
...
def find_matches_id_parent(possibilities, typed_obj)
	matches = []
